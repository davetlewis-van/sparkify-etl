...
def process_song_file(cur, filepath):
    """Extracts values from a single song JSON file.

    Inserts records in the songs and artists tables.
    ...
    filepath : string
        The filepath to the JSON song file to process.
    """
...
def process_log_file(cur, filepath):
    ...
    filepath : string
        The filepath to the JSON log file to process.
    """
